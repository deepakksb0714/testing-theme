...
const Login = (props:any) => {
    document.title = "Login | scalarHub Admin Dashboard";
   ...
   const { clientId, userPoolId } = useClientDetails();
    ...
    const dispatch: any = useDispatch();
      ...
      const validation: any = useFormik({
          ...
          onSubmit: (values:any) => { 
              dispatch(loginUser(values, props.router.navigate,clientId || '', userPoolId || ''));
          }
      });
                                        ...
                                        <div className="d-flex flex-column h-100 py-0 py-xl-4">
                                                    ...
                                                    <Col lg={6}>
                                                        <Card.Body className="p-lg-5 p-4">
                                                            <div className="text-center">
                                                                ...
                                                                <p className="text-muted mt-2">Sign in to continue to ScalarHub.</p>
                                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                <p className="mb-0 text-muted">
                                                    &copy; {new Date().getFullYear()} ScalarHub. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand
                                                </p>
                                            </div>
                                        </div>
                                    </div>
